...
namespace SingletonClient.Implementation
{
    public class SingletonUtil
    {
        ...
        public static bool CheckResponseValid(JToken token)
        {
            if (token == null)
            {
                return false;
        ...
        public static JObject HttpGetJson(IAccessService accessService, string url)
        {
            string text = accessService.HttpGet(url);
        ...
        public static JObject HttpPost(IAccessService accessService, string url, string text)
        {
            string responseData = accessService.HttpPost(url, text);
