...
namespace UnitTestSingleton
{
    ...
    public class TestClient
    {
        ...
        public void TestUtil()
        {
            ...
            text = BaseIo.obj().HttpGet("11.22.33");
            Assert.AreEqual(text, "");

            text = BaseIo.obj().HttpPost("11.22.33", "44.55");
            ...
            Assert.AreEqual(SingletonUtil.CheckResponseValid(null), false);
            ...
            JObject obj = SingletonUtil.HttpPost(BaseIo.obj(), "__url", "body");
